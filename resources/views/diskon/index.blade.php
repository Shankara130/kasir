    ...
    <div class="col-lg-12">
        <div class="box">
            <div class="box-header with-border">
                <div class="btn-group">
                    <button onclick="addForm('{{ route('diskon.store') }}')" class="btn btn-success btn-xs btn-flat"><i
...
@push('scripts')
    <script>
        ...
        function editForm(url) {
            ...
            $.get(url)
                .done((response) => {
                    $('#modal-form [name=nama_diskon]').val(response.nama_diskon);
                    $('#modal-form [name=total_diskon]').val(response.total_diskon);
                })
                .fail((errors) => {
